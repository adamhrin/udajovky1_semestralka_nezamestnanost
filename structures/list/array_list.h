...
namespace structures
{
	...
	inline ArrayList<T>& ArrayList<T>::operator=(const ArrayList<T>& other)
	{
		if (this != &other)
		{
			//arrayCopy_(new Array<T>(*(other.array_)));
			//Array<T>* arrayCopy = new Array<T>(*(other.array_));
			delete array_;
			array_ = new Array<T>(*(other.array_));
			size_ = other.size_;
		}
	...
	{
		Array<T>* arrayNew_ = new Array<T>(size_ * 2);
		Array<T>::copy(*array_, 0, *arrayNew_, 0, static_cast<int>(size_));
		delete array_;
		array_ = arrayNew_;
	}
	...
	{
		Array<T>* arrayNew_ = new Array<T>((array_->size()/2));
		Array<T>::copy(*array_, 0, *arrayNew_, 0, static_cast<int>(size_));
		delete array_;
		array_ = arrayNew_;
	}
